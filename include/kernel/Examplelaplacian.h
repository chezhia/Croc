...
#ifndef EXAMPLELAPLACIAN_H
#define EXAMPLELAPLACIAN_H
 ...
 */
class Examplelaplacian : public Kernel
{
public:
   ...
   */
  Examplelaplacian(const InputParameters & parameters);
